...
import AutomationTest2.ScreenRecorderUtil;

public class SafariUITsting {
	...
	private static void captureScreenshots(SafariDriver driver, String device, String[] desktopResolutions) {
		// TODO Auto-generated method stub
	...
	public static void captureScreenshots(FirefoxDriver driver, String device, String[] resolutions) {
      for (String resolution : resolutions) {
          ...
          String folderPath = "Safari screenshots/" + device + "/" + resolution;
